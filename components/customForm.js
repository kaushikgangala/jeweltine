...
export default function CustomOrderForm() {
    ...
    const [customization, setCustomization] = useState({
        ...
        "From Name": "",
        "Custom Text":
            "I like to be healthy in terms of my diet, that's why I always prefer to eat you.",
        name: "Interlocked Hearts",
...
Here are the details of your order:
    ...
    Product Name: ${customization.name}
    Customization Details: To Name - ${customization["To Name"]}, From Name - ${customization["From Name"]}, Text - ${customization["Custom Text"]}
    Total: $${customization.quantity === 2 ? 99.9 : customization.Price}
                                    ...
                                    (field === "To Name" || field === "From Name") && (
                                        <div key={field} className="mb-4">
                                            ...
                                            <input
                                                ...
                                                placeholder={field === 'To Name' ? 'Jane' : 'Dave'}
                                                required
                            ...
                            <div className="flex flex-col gap-5 ">
                                ...
                                <label>
                                    <input
                                        type="radio"
                                        name="Custom Text"
                                        value="I like to be healthy in terms of my diet, that's why I always prefer to eat you."
                                        onChange={handleOptionChange}
                                        defaultChecked
                                    />
                                    I like to be healthy in terms of my diet, that&lsquo;s why I always prefer to eat you.
                                </label>
                                <label>
                                    <input
                                        type="radio"
                                        name="Custom Text"
                                        value="You’re my favorite package to unwrap… and I’m always ready for express delivery."
                                        onChange={handleOptionChange}
                                    />
                                    You&lsquo;re my favorite package to unwrap… and I&lsquo;m always ready for express delivery.
                                </label>
                                <label>
                                    <input
                                        type="radio"
                                        name="Custom Text"
                                        value="You’re the reason I don’t need a gym… because, baby, you’re my cardio."
                                        onChange={handleOptionChange}
                                    />
                                    You&lsquo;re the reason I don&lsquo;t need a gym… because, baby, you&lsquo;re my cardio.
                                </label>
                                <label>
                                    <input
                                        type="radio"
                                        name="Custom Text"
                                        value="You’re the only thing I want in bed… besides maybe pizza, but even then, you’d win."
                                        onChange={handleOptionChange}
                                    />
                                    You&lsquo;re the only thing I want in bed… besides maybe pizza, but even then, you&lsquo;d win.
                                </label>
                                <label>
                                    <input
                                        type="radio"
                                        name="Custom Text"
                                        value="You’re the only drama I want in my life… especially when it’s between the sheets."
                                        onChange={handleOptionChange}
                                    />
                                    You&lsquo;re the only drama I want in my life… especially when it&lsquo;s between the sheets.
                                </label>
                                ...
                                <label>
                                    <input
                                        type="radio"
                                        name="Custom Text"
                                        value="You’re my favorite snack—salty, sweet, and always better when I’m a little hungry."
                                        onChange={handleOptionChange}
                                    />
                                    You&lsquo;re my favorite snack—salty, sweet, and always better when I&lsquo;m a little hungry.
                                </label>
                                ...
                                <label>
                                    <input
                                        type="radio"
                                        name="Custom Text"
                                        value="You’re the reason I wake up with a smile… and sometimes with a sore back."
                                        onChange={handleOptionChange}
                                    />
                                    You&lsquo;re the reason I wake up with a smile… and sometimes with a sore back.
                                </label>
                                <label>
                                    <input
                                        type="radio"
                ...
                Upload image
                            ...
                            <button
                                ...
                                disabled={
                                    images.length === 0 ||
                                    images.length > 1 ||
                                    !customization["To Name"] ||
                                    !customization["From Name"] ||
