export function transformLink(originalLink) {
  ...
  const bucket = match[1]; // Bucket name (e.g., "jeweltine")
...
try {
  const originalLink =
    "https://jeweltine.s3.us-east-1.amazonaws.com/orders/temp/a2af5e80-03c0-43b1-b6a9-833cc6ad01e5-img1.jpg";
  const transformedLink = transformLink(originalLink);
  //   console.log(transformedLink);
  // Output: "https://s3.us-east-1.amazonaws.com/jeweltine/orders/temp/a2af5e80-03c0-43b1-b6a9-833cc6ad01e5-img1.jpg"
} catch (error) {
